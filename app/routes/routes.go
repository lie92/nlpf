...
func (_ tAdmin) AcceptOffer(
		tag int,
		) string {
	args := make(map[string]string)
	
	revel.Unbind(args, "tag", tag)
	return revel.MainRouter.Reverse("Admin.AcceptOffer", args).URL
}

func (_ tAdmin) RefuseOffer(
		tag int,
		) string {
	args := make(map[string]string)
...
func (_ tClient) Modify(
		id int,
		) string {
	args := make(map[string]string)
	
	revel.Unbind(args, "id", id)
	return revel.MainRouter.Reverse("Client.Modify", args).URL
}

func (_ tClient) ModifyDemande(
		address string,
		motif string,
		phone string,
		id int,
